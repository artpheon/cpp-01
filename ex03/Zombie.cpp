...
Zombie* Zombie::getRandZomb(unsigned seed) {
	Zombie *z = new Zombie();
	z->setType(Zombie::randName(6, seed));
	z->setName(Zombie::randName(5, seed));
	return (z);
}

std::string Zombie::randName(unsigned size, unsigned seed) {
